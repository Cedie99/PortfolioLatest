...
export default function AboutSection() {
  ...
  // Reduced parallax offset for mobile to prevent layout weirdness
  ...
  return (
    <section 
      ...
      id="about"
    >
      {/* Dynamic Background Gradients - Adjusted for better mobile performance */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mb-20 md:mb-40">
          ...
          <div className="lg:col-span-4 flex flex-col justify-end">
            ...
            <motion.div 
              ...
              className="p-8 md:p-10 rounded-[2rem] md:rounded-[3rem] bg-zinc-900/10 border border-white/10 backdrop-blur-3xl relative group overflow-hidden shadow-2xl"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16 border-t border-zinc-900 pt-16 md:pt-20">
          <Pillar 
